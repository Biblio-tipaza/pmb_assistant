...
<style>
    ...
    /* الأزرار */
    .stButton button, .stDownloadButton button, [data-testid="stFileUploader"] button, a.custom-export-btn, [data-testid="stLinkButton"] a {
        background-color: #0E424B !important;
        color: #ffffff !important;
        border: 1px solid #3FE0D0 !important;
    ...
    .stButton button:hover, .stDownloadButton button:hover, [data-testid="stFileUploader"] button:hover, a.custom-export-btn:hover, [data-testid="stLinkButton"] a:hover {
        background-color: #3FE0D0 !important;
        color: #0E424B !important;
        border-color: #ffffff !important;
    }
    ...
    if uploaded_files:
        ...
        if st.button(
            ...
            if not api_key:
                ...
                try:
                    with st.spinner(
                        "جاري قراءة جميع الصفحات المرفوعة ومطابقة البيانات الببليوغرافية..."
                    ):
                        ...
                        st.success("✅ تم تحليل كافة الصفحات واستخرج البيانات بنجاح!")
                        st.rerun()
...
with col_right:
    ...
    with col_btn1:
        ...
        if export_option == "تصدير الملف لـ PMB (UNIMARC XML)":
            ...
            base_url = urls[export_option]
            target_link = f"{base_url}?{query_string}"
